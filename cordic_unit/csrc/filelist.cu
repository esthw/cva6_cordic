...
ARCHIVE_OBJS=
ARCHIVE_OBJS += _271585_archive_1.so
_271585_archive_1.so : archive.25/_271585_archive_1.a
	@$(AR) -s $<
	@$(PIC_LD) -shared  -Bsymbolic  -o .//../simv.daidir//_271585_archive_1.so --whole-archive $< --no-whole-archive
	@rm -f $@
	@ln -sf .//../simv.daidir//_271585_archive_1.so $@
